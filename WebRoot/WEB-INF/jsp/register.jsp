					...
					<table>
						<tbody>
							...
							<tr>
								...
								<td><input type="password" id="password" name="password" style="float:left;" value="<s:property value='model.password'/>"
							...
							<tr>
								...
								<td><input type="password" id="repassword" style="margin-top:2px;" value="<s:property value='model.password'/>"
							...
							<tr>
								<th>姓名:</th>
								<td><input type="text" name="name" class="text" maxlength="200" value="<s:property value='model.name'/>" style="margin-top:2px;"/>
								</td>
							</tr>
							<tr>
								<th>性别:</th>
								<td>
									<span class="fieldSet" style="margin-top:2px;">
							...
							<tr>
								...
								<td><span class="fieldSet">
									<input style="float:left; margin-top:2px;" type="text" 
										id="checkcode" name="checkcode" class="text captcha" maxlength="4"/>
										<img id="checkImg" class="captchaImage" style="float:left;"
