...
<div class="container productList">
	...
	<div style="width: 950px;height: 20px;border-width:1px solid red;margin:6px auto;">
		<span style="font-family:'微软雅黑'; font-size:16px;">
			当前栏目：<s:property value="category.cname"/>
		</span>
	</div>
	<div class="span18 last">
		...
		第	<s:property value="pageBean.page"/> / <s:property value="pageBean.totalPage"/> 页
			<s:if test="pageBean.page != 1">
				<a href="${pageContext.request.contextPath}/book_findByCid.action?cid=<s:property value="cid"/>&pageNum=1" class="firstPage">&nbsp;</a>		
				<a href="${pageContext.request.contextPath}/book_findByCid.action?cid=<s:property value="cid"/>&pageNum=<s:property value="pageBean.page-1"/>" class="previousPage">&nbsp;</a>	
			</s:if>	
			<s:iterator var="i" begin="1" end="pageBean.totalPage" step="1">
				...
				<s:else>
					<a href="${pageContext.request.contextPath}/book_findByCid.action?cid=<s:property value="cid"/>&pageNum=<s:property value="#i"/>"><s:property value="#i"/></a>
				</s:else>
			</s:iterator>
				
			<s:if test="pageBean.page != pageBean.totalPage">
				<a class="nextPage" href="${pageContext.request.contextPath}/book_findByCid.action?cid=<s:property value="cid"/>&pageNum=<s:property value="pageBean.page+1"/>">&nbsp;</a>
				<a class="lastPage" href="${pageContext.request.contextPath}/book_findByCid.action?cid=<s:property value="cid"/>&pageNum=<s:property value="pageBean.totalPage"/>">&nbsp;</a>
			</s:if>	
		</div>
	</div>
</div>
