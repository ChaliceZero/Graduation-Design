...
<script type="text/javascript">
	function addUser(){
		window.location = "${pageContext.request.contextPath}/admin_categoryAdd.action";				
	}
	//&#28155;&#21152;添加
</script>
</head>
<body>
		<table cellSpacing="1" cellPadding="0" width="100%" align="center" border="0">
			<tbody>	
				...
				<tr>
					<td align="left">
						<button type="button" value="添加一级分类" style="width:154px; height:28px;" onclick="addUser()">
							添加一级分类
						</button>
					</td>
				</tr>
							...
							<s:iterator var="c" value="cList" status="status">
								<tr onmouseover="this.style.backgroundColor = '#ccc'"
									...
									<td align="center" style="HEIGHT: 22px">
										<a href="${pageContext.request.contextPath}/category_adminEditPage.action?cid=<s:property value="#c.cid"/>">
