							...
							<s:iterator var="cs" value="pageBean.list" status="status">
								...
								<td align="center" width="18%" colspan="5">
									...
									<s:if test="pageBean.page != 1">
										<a href="${pageContext.request.contextPath}/categorySecond_adminFindAll.action?pageNum=1">首页</a> |
										<a href="${pageContext.request.contextPath}/categorySecond_adminFindAll.action?pageNum=<s:property value="pageBean.page-1"/>">上一页</a> |
									</s:if>
									<s:if test="pageBean.page != pageBean.totalPage">
										<a href="${pageContext.request.contextPath}/categorySecond_adminFindAll.action?pageNum=<s:property value="pageBean.page+1"/>">下一页</a> |
										<a href="${pageContext.request.contextPath}/categorySecond_adminFindAll.action?pageNum=<s:property value="pageBean.totalPage"/>">尾页</a>
									</s:if>
								</td>
							</tr>
						</table>
