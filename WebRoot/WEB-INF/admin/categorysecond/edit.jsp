...
<body>
	<form action="${pageContext.request.contextPath}/categorySecond_adminUpdate.action?csid=<s:property value="model.csid"/>" method="post" enctype="multipart/form-data">
