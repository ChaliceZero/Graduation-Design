...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<h1 style="display:inline-block;">支付宝电脑网站支付体验入口页 - 教育书城</h1>
	<h1 style="display:inline-block;margin-left:200px;"><a href="${pageContext.request.contextPath}/index.action" style="color:#fff;text-decoration: none;">书城首页</a></h1>
	</header>
	<div id="main">
		...
		<form name="alipayment" action="${pageContext.request.contextPath}/alipay/alipay.trade.page.pay.jsp" method="post"
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd><!-- <s:property value="order.oid"/> -->
						<input id="WIDout_trade_no" name="WIDout_trade_no" value="<s:property value="WIDout_trade_no"/>" readonly/>
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="EduBook" readonly/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd><!-- <s:property value="order.total"/> -->
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="<s:property value="order.total"/>" readonly/>
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" value="Nice book!!!" readonly/>
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
